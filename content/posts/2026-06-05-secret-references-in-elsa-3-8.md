...
The later [JavaScript evaluator work for Elsa 3.9](/blog/safer-faster-javascript-expressions-elsa-3-9) awaits those promise-compatible values without holding a thread pool thread and adds configurable execution limits around the expression.
